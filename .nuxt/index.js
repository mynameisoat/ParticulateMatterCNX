...
import nuxt_plugin_dataviewpluginf7ea3de4_353f6f0f from 'nuxt_plugin_dataviewpluginf7ea3de4_353f6f0f' // Source: .\\dataview.plugin.f7ea3de4.js (mode: 'all')
...
import nuxt_plugin_allFormat_289300dd from 'nuxt_plugin_allFormat_289300dd' // Source: ..\\filters\\allFormat (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"เว็บไซต์สำหรับการตรวจสอบค่าฝุ่นละอองในอากาศในจังหวัดเชียงใหม่","htmlAttrs":{"lang":"th"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ficon-app.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_8bf5c9c6 === 'function') {
    await nuxt_plugin_plugin_8bf5c9c6(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_079e92c0 === 'function') {
    await nuxt_plugin_axios_079e92c0(app.context, inject)
  }

  if (typeof nuxt_plugin_dataviewpluginf7ea3de4_353f6f0f === 'function') {
    await nuxt_plugin_dataviewpluginf7ea3de4_353f6f0f(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_configpluginripple200095f0_67c77f82 === 'function') {
    await nuxt_plugin_configpluginripple200095f0_67c77f82(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_vuetyped_51c23e5f === 'function') {
    await nuxt_plugin_vuetyped_51c23e5f(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_allFormat_289300dd === 'function') {
    await nuxt_plugin_allFormat_289300dd(app.context, inject)
  }
